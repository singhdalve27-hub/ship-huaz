            ...
            <div class="flex flex-col max-h-[calc(100dvh-2rem)] sm:max-h-[calc(100dvh-3.5rem)]">
                <div class="p-4 sm:p-6 border-b border-slate-100 bg-sky-950 text-white flex items-center justify-between gap-3 shrink-0">
                    ...
                    <button
                        ...
                        class="text-sky-300 hover:text-white p-2 rounded-lg transition-colors shrink-0 cursor-pointer"
                    >
                ...
                <!-- Search & Filters -->
                <div class="p-3.5 sm:p-5 bg-slate-50 border-b border-slate-200 flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 sm:gap-3 shrink-0">
                ...
                <div class="p-3.5 sm:p-4 bg-slate-50 border-t border-slate-200 flex justify-end shrink-0">
                    <button
                        @click="closeScheduleModal"
                        class="w-full sm:w-auto px-5 py-2 bg-sky-900 hover:bg-sky-800 text-white font-bold rounded-xl text-xs transition-colors shadow-sm cursor-pointer"
                    >
                        Close Manifest
                    </button>
                </div>
